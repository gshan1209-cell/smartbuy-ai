...
- [ ] 手機篩選器改 Drawer / Bottom Sheet
- [ ] 商品結果卡片顯示品名、今日價格、狀態、建議、更新時間
- [ ] 專業市場情報移至「進階資訊」摺疊區或後台
- [ ] 桌機保留效率較高的雙欄／表格模式
- [ ] 平板改兩欄，不得直接縮小桌機版
- [ ] 修正 MarketSelector 固定寬度造成的小螢幕問題
...
- [ ] 已讀／未讀
- [ ] 篩選與空狀態
- [ ] 沿用既有 notifications API，可先以 adapter 統一格式
...
- [ ] 顯示可能受天氣影響品項
- [ ] 顯示節氣料理建議
- [ ] 資料尚未接 API 時以明確 mock / static seed 實作
